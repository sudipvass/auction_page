    ...
    <>
      <div className='pt-20    group '>
        ...
        <p className='font-bold text-3xl text-center relative flex flex-col sm:flex-row'>
          Latest Auction <span className='flex  sm:flex-row sm:pl-2'> Near You <span className='text-center flex m-4 bg-primary2 h-[5px] w-16 sm:w-24 transition-all duration-300 ease-in-out transform group-hover:w-32 group-hover:bg-yellow-700'></span></span>
        </p>
